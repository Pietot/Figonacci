...
- **[Rust implementation of the Pihedron algorithm](https://github.com/Pietot/rust-fibonacci)**: My Rust implementation of the Pihedron algorithm to get the best performance.