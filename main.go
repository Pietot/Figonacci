...
func printUsage() {
	...
	fmt.Println("")
	fmt.Println("        1 - \033[31mrecursive\033[0m")
	fmt.Println("        2 - \033[33mrecursive_optimized\033[0m")
	fmt.Println("        3 - \033[33miterative\033[0m")
	fmt.Println("        4 - \033[32mmatrix\033[0m")
	fmt.Println("        5 - \033[36mmatrix_optimized\033[0m")
	fmt.Println("        6 - \033[34mfield_extension\033[0m")
	fmt.Println("")
}
