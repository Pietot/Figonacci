...
func printUsage() {
	...
	fmt.Println("")
	fmt.Println("        1 - \033[34mpihedron (p)\033[0m")
	fmt.Println("        2 - \033[36mfield_extension (fe)\033[0m")
	fmt.Println("        3 - \033[36mmatrix_optimized (mo)\033[0m")
	fmt.Println("        4 - \033[32miterative (i)\033[0m")
	fmt.Println("        5 - \033[33mrecursive_optimized (ro)\033[0m")
	fmt.Println("        6 - \033[33mmatrix (m)\033[0m")
	fmt.Println("        7 - \033[31mrecursive (r)\033[0m")
	fmt.Println("")
}
...
func isValidAlgorithm(algorithm string) (func(int, context.Context) *big.Int, string) {
	validAlgorithms := map[string]struct {
		...
		"pihedron":            {algorithms.Pihedron, "pihedron"},
		"p":                   {algorithms.Pihedron, "pihedron"},
	}
